...
public class CollectablesCollisionHandler implement CollisionHandler {
	
	
	public int CollisionResult handle(GameEngine engine, GameObject obj1, GameObject obj2) {
