...
public class StrategistPathTest {
    ...
    public void setUp() {
        ...
        monster = new Strategist(new Point(0,2));
        pg = monster.getDefaultPathGenerator();
...
//        mb.addObject(wall3);
    ...
    public void isRightPathTest1(){
        ...
        LinkedList<Point> path = pg.generatePath(map, monster, player.location);
    ...
    public void isRightPathTest3(){
        ...
        LinkedList<Point> path = pg.generatePath(map, monster, player.getLocation());
        long time = System.nanoTime() - start;
        System.out.println(time);
        LinkedList<Point> check = new LinkedList<>();
