...
/**
 * Controller for the screen of playing dungeon
 */
public class DungeonPlayController extends Controller {
    ...
    /**
     * Main animation(loop) of the game
     */
    private AnimationTimer mainAnimation;

    /**
     * ListView for player inventory
     */
	@FXML
	private ListView<String> inventoryItems;

    /**
     * HBox for holding all timer indicators
     */
	@FXML
    private HBox timerBox;

    /**
     * Indicative pane for pausing game
     */
	@FXML
    ...
    /**
     * Keep a reference of original unmodified map
     * for restart
     */
    ...
    /**
     * Time consumed after start in seconds
     */
